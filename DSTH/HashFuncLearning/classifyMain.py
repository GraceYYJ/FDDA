...
from .classifyModel import Model
from .classifyTrain import Train
from DSTH.Common.utils import pp, show_all_variables
...
flags.DEFINE_string("checkpoint_dir", "../classifymodel/checkpoint", "Directory name to save the checkpoints [checkpoint]")
